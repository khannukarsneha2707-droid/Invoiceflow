        ...
        <Card className="border-border shadow-lg">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Start your professional invoicing journey
            </CardDescription>
          </CardHeader>
          <CardContent className="grid gap-4">
            ...
            <form onSubmit={handleRegister} className="grid gap-4">
              ...
              <Button className="w-full bg-accent hover:bg-accent/90 text-accent-foreground font-bold mt-2" type="submit" disabled={loading}>
                {loading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : "Create with Email"}
              </Button>
            </form>
          </CardContent>
